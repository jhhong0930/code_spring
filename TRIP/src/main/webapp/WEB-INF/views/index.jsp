...
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-menu">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="../../../../../../Trip-project/HTML/city-guides.html">City Guides</a></li>
            <li class="nav-item"><a class="nav-link" href="../../../../../../Trip-project/HTML/services.html">Services</a></li>
            <li class="nav-item"><a class="nav-link" href="../../../../../../Trip-project/HTML/travel.html">Travel With Us</a></li>
            <li class="nav-item"><a class="nav-link" href="../../../../../../Trip-project/HTML/contact.html">Contact</a></li>
          </ul>
        </div>
      </div>
    </nav>
        ...
        <div class="row align-items-center">
          <div class="col-md">
            ...
            <p class="lead mb-5 probootstrap-animate">
              ...
              <a href="../../../../../../Trip-project/HTML/onepage.html" role="button" class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">See OnePage Verion</a>
            </p>
          </div> 
            ...
            <blockquote class="">
              ...
              <p class="probootstrap-author">
                <a href="https://probootstrap.com/" target="_blank">
                  <img src="resources/images/person_1.jpg" alt="Free Template by ProBootstrap.com" class="rounded-circle">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="resources/images/img_1.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
          ...
          <div class="col-lg-3 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="resources/images/img_2.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
              <h3>Road</h3>
            </a>
          </div>
          <div class="col-lg-3 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="resources/images/img_3.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
              <h3>Australia</h3>
            </a>
          </div>
          <div class="col-lg-3 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="resources/images/img_4.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
              <h3>Japan</h3>
            </a>
          </div>
        </div>
    ...
    <section class="probootstrap-section-half d-md-flex" id="section-about">
      <div class="probootstrap-image probootstrap-animate" data-animate-effect="fadeIn" style="background-image: url(resources/images/img_2.jpg)"></div>
      <div class="probootstrap-text">
    ...
    <section class="probootstrap-section-half d-md-flex">
      <div class="probootstrap-image order-2 probootstrap-animate" data-animate-effect="fadeIn" style="background-image: url(resources/images/img_3.jpg)"></div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="probootstrap-media-image" style="background-image: url(resources/images/img_1.jpg)">
              </div>
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="probootstrap-media-image" style="background-image: url(resources/images/img_2.jpg)">
              </div>
              <div class="media-body">
          ...
          <div class="col-md-6">
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="probootstrap-media-image" style="background-image: url(resources/images/img_4.jpg)">
              </div>
              <div class="media-body">
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="probootstrap-media-image" style="background-image: url(resources/images/img_5.jpg)">
              </div>
              <div class="media-body">
